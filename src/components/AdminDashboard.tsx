                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <button
                            type="button"
                            onClick={() => {
                              const text = `Hola ${selectedLead.fullName}, le escribe el equipo directivo de Specifinance S.A.S. Hemos estado analizando la necesidad de su empresa ${selectedLead.companyName} respecto a "${selectedLead.serviceOfInterest}". Nos encantaría agendar un breve diagnóstico de 15 minutos en nuestro Calendly: https://calendly.com/specifinance/consultoria`;
