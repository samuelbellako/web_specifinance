...
import { 
  Briefcase, Palette, Cpu, ChevronRight, ArrowRight, CheckCircle, 
  HelpCircle, Sparkles, MessageSquare, ShieldCheck
} from 'lucide-react';
...
export default function SmeSolutions({ onSelectSmeNeed }: SmeSolutionsProps) {
  const [activeCard, setActiveCard] = useState<'restructuracion' | 'marca' | 'procesos' | null>('restructuracion');
  ...
  const pymeSolutions = [
    ...
    },
    {
      ...
      solution: "Estructuramos tu empresa con herramental lógico de nivel corporativo. Configuramos automatizaciones comerciales, capacitamos a tu equipo sobre KIPs claros y te montamos dashboards en vivo para que todo opere de forma predecible sin ti.",
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="inline-flex py-1 px-3 bg-indigo-50 border border-indigo-100 rounded text-indigo-700 font-sans text-[11px] tracking-widest uppercase font-semibold">
            ⚡ Respuestas Prácticas para Tomadores de Decisiones
          </span>
          <h2 className="font-heading font-extrabold text-3xl md:text-5xl text-deep-navy leading-tight tracking-tight">
            Consultoría Boutique de Impacto <span className="text-indigo-650">Directo en tu PyME</span>
          </h2>
          <p className="text-charcoal-text text-sm md:text-base leading-relaxed">
            No creemos en manuales estáticos ni en reportes teóricos de 100 páginas. Sabemos que dirigir una pequeña o mediana empresa exige soluciones ágiles y realistas. Te ayudamos a estructurar la empresa del futuro hoy con un plan a tu medida.
          </p>
        </div>

        {/* Tab Selection buttons for mobile or focused view */}
        ...
        {/* Dynamic Solution Resolution Summary Banner */}
        <div className="bg-gradient-to-br from-deep-navy to-slate-900 text-white rounded-2xl p-8 md:p-12 relative overflow-hidden border border-white/10 shadow-xl">
          ...
          <div className="relative z-10 max-w-3xl space-y-6 text-left">
            ...
            <p className="text-white/80 text-xs md:text-sm leading-relaxed">
              Unimos la dirección analítica contable de un CEO/CFO externo con la maquinaria comercial de un Growth Marketer. Esto significa que **nunca tomamos una decisión de marketing sin calcular tus márgenes financieros primero**, y **nunca reestructuramos tus costos sin diseñar un motor de ventas para sustituir ingresos**. Es una retroalimentación perfecta de alto valor.
            </p>
